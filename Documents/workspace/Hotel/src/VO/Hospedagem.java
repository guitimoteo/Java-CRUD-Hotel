...
public class Hospedagem {
    ...
    public Hospedagem(String nomeHospede, String dataEntrada, String dataSaida, String hora, Hospede hospede, Quarto quarto){
   ...
   // }
    ...
    public Hospedagem (int codHospedagem, String nomeHospede, String dataEntrada, String dataSaida, String hora, Hospede hospede, Quarto quarto){
        this(nomeHospede, dataEntrada, dataSaida, hora, hospede, quarto);
   ...
   public int getDiferencaData(String dataInicial, String dataFinal){
     ...
     * @param dataEntrada Data no formato dd/mm/aaaa
     * @param dataSaida Data no formato dd/mm/aaaa
  ...
  String data1= dataEntrada;

  String data2=dataSaida;
