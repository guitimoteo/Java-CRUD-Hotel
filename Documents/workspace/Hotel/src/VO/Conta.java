...
public class Conta {
  //Criacao dos atributos
    ...
    public Conta (String prodConsumo, String servConsumo, int qtdProduto, int qtdServico, String dataEntrada, String dataSaida, double valorTotal, double valorConsumo, double valorHospedagem){
