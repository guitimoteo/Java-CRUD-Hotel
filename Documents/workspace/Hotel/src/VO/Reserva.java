...
public class Reserva {
 //Criacao dos atributos
    ...
    public Reserva(String nomeFuncionario, String nomeHospede, String situacao,String dataEntrada,String dataSaida,
            String horaReserva, double taxaReserva, String tipoQuarto,
            int qtdAcompanhante){
   ...
   public Reserva (int codReserva, String nomeFuncionario, String nomeHospede, String situacao, String dataEntrada,String dataSaida,
            String horaReserva, double taxaReserva, String tipoQuarto, int qtdAcompanhante){
        this(nomeFuncionario, nomeHospede, situacao, dataEntrada, dataSaida, horaReserva, taxaReserva, tipoQuarto, qtdAcompanhante);
        setCodReserva (codReserva);
        
    }
   
   public Reserva (int codReserva, String nomeFuncionario, String nomeHospede, String situacao, String dataEntrada, String dataSaida,
           String horaReserva, double taxaReserva, String tipoQuarto, int qtdAcompanhante, Quarto quarto){
   ...
   //Só pode fazer a reserva se passar um quarto.
    ...
    /**
     * @param funcionario the codReserva to set
     */
    ...
    /**
     * @param nomeHospede the codReserva to set
     */
